...
srun --gpus=1\
 ...
 bash -c "nvidia-smi && python ./pytorch/train.py train --config_path=./configs/pointpillars/car/xyres_16_sparse_me1.config --model_dir=./model_dir_car_16_sparse_me1_higher_learning/"
# --pty\
