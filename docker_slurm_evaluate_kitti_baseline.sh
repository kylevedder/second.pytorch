...
srun --gpus=1\
 ...
 bash -c "nvidia-smi && python ./pytorch/train.py evaluate --config_path=./configs/pointpillars/car/xyres_16.config --model_dir=./model_dir_car_16_baseline/ --measure_time=True"
# -w node-3090-1\
# --pty\
