...
srun --gpus=1\
 ...
 bash -c "nvidia-smi && python ./pytorch/train.py evaluate --config_path=./configs/pointpillars/car/xyres_16_sparse_me3.config --model_dir=./model_dir_car_16_sparse_me3/ --measure_time=True"
# -w node-3090-1\
# --pty\
