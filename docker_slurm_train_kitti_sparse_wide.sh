...
srun --gpus=1\
 ...
 bash -c "nvidia-smi && python ./pytorch/train.py train --config_path=./configs/pointpillars/car/xyres_16_sparse_wide.config --model_dir=./model_dir_car_16_sparse_wide/"
# -w node-3090-1\
# --pty\
