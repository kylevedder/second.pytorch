...
srun --gpus=1\
 ...
 bash -c "nvidia-smi && python ./pytorch/train.py evaluate --config_path=./configs/nuscenes/all.pp.largea_sparse.config --model_dir=./model_dir_nuscenes_car_16_sparse/ --measure_time=True"
# -w node-3090-1\
# --pty\
